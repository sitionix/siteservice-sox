...
class SiteMetaDeletedPublisherV1Test {
    ...
    @Test
    void givenPublisher_whenPayloadClass_thenReturnSiteDeletedPayloadClass() {
        //given

        //when
        final Class<SiteDeletedPayload> payloadClass = this.siteMetaDeletedPublisherV1.payloadClass();

        //then
        assertThat(payloadClass).isEqualTo(SiteDeletedPayload.class);
    }
